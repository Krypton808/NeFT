...
# mask_dict = make_mask_with_dict()

mask_dict = torch.load(
    r'/data5/haoyun.xu/study/MI/MMMI/src/MI/experiment_setup/find_neuron/results/neurons_sim/final/train_enzh_org/3200step/150000/mask_cos.pt')


# mask_dict = torch.load(
#     r'/data5/haoyun.xu/study/MI/MMMI/src/MI/experiment_setup/find_neuron/results/neurons_sim/train_enzh_org_/1epoch/mask_cos_offload.pt')
...
class Trainer:
    ...
    def __init__(
        ...
        # print(mask_dict_path)
        # self.mask_dict = torch.load(mask_dict_path)
                                ...
                                for i in range(32):
                                    if '.' + str(i) + '.' in k:
                                        ...
                                        if layer_name in mask_dict.keys():
                                            ...
                                            # if v.grad.shape[0] != 11008 and v.grad.shape[0] != 4096:
                                            # if v.grad.shape[0] != 11008*4096:
