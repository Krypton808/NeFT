...
def make_mask_with_dict_for_offload(
        path=r'/data5/haoyun.xu/study/MI/MMMI/src/MI/experiment_setup/find_neuron/results/summary_neurons_sim/enfr/org_allsft/final/neuron_dict_0.9999153.json'):
...
# mask_dict = make_mask_with_dict_for_offload()

mask_dict = torch.load(
    r'/data5/haoyun.xu/study/MI/MMMI/src/MI/experiment_setup/find_neuron/results/summary_neurons_sim/enfr/org_allsft/final/mask_cos_0.9999153_for_offload.pt')
