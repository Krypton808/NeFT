...
import torch
import transformers
# from trainer_add_grad_mask import Trainer
...
def compute_metrics(eval_preds):
    ...
    metric = evaluate.load("/data/tigerbot/tigerbot_geely/test/fc/tools/evaluate_metric/accuracy")
    # metric = evaluate.load("/root/test/tools/evaluate_metric/accuracy")
