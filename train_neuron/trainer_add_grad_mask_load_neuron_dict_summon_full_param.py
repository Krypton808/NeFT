...
mask_dict = torch.load(
    r'/data5/haoyun.xu/study/MI/MMMI/src/MI/experiment_setup/find_neuron/results/neurons_sim/train_enzh_org/1epoch/mask_cos_offload.pt')
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    for k_m, v_m in model.named_modules():
                        with FSDP.summon_full_params(v_m, with_grads=False, rank0_only=False, recurse=True):
                            for k, v in v_m.named_parameters():
                                if v.grad == None:
                                    continue
                                if v.grad.shape[0] != 4096 and v.grad.shape[0] != 11008:
                                    continue
