...
step_number = 0
def list_to_sn_dict():
    sn_list = list(['1_20_out', '1_1331_out', '1_1936_in', '1_2069_in', '1_2069_out', '1_4600_in', '1_9015_out', '1_9350_in', '1_9805_out', '1_10397_out', '2_1325_in', '2_1325_out', '2_3699_in', '2_5201_out', '2_8637_in', '2_10040_in', '3_1370_in', '3_1370_out', '3_3687_out', '3_8948_out', '3_9352_in', '4_328_in', '4_328_out', '4_1522_in', '4_4336_in', '4_9116_in', '6_4469_in', '2_10695_out', '1_7890_in'])
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    #             continue
                    #
                    #         # if '.4.' in k and 'mlp' in k and 'up_proj' in k or \
                    #         #         '.5.' in k and 'mlp' in k and 'up_proj' or \
                    #         #         '.6.' in k and 'mlp' in k and 'up_proj' or \
                    #         #         '.7.' in k and 'mlp' in k and 'up_proj' or \
                    #         #         '.8.' in k and 'mlp' in k and 'up_proj' or \
                    #         #         '.9.' in k and 'mlp' in k and 'up_proj':
                    #         if 'mlp' in k and 'up_proj' in k:
                    #             # print(k)
                    #             # print(v)
                    #             # print(v.shape)
                    #             # print(type(v))
                    #             # print(v.grad)
                    #             # print(v.grad.shape)
                    #             # 5*11008 + 329 = 55369 == 13 * 4096 + 2120
                    #             mask = torch.zeros_like(v.grad)  # torch.Size([45088768])
                    #             # print(mask.shape)
                    #             mask[328 * 4096: 329 * 4096] = 1
                    #             # mask[100 * 4096: 101 * 4096] = 1
                    #             # print(mask)
                    #             # print(mask.shape)
                    #             v.grad *= mask
                    #             # print('------------------------------')
                    #         # elif '.4.' in k and 'mlp' in k and 'down_proj' in k or \
                    #         #         '.5.' in k and 'mlp' in k and 'down_proj' in k or \
                    #         #         '.6.' in k and 'mlp' in k and 'down_proj' in k or \
                    #         #         '.7.' in k and 'mlp' in k and 'down_proj' in k or \
                    #         #         '.8.' in k and 'mlp' in k and 'down_proj' in k or \
                    #         #         '.9.' in k and 'mlp' in k and 'down_proj' in k:
                    #         elif 'mlp' in k and 'down_proj' in k:
                    #             # print(k)
                    #             # print(v)
                    #             # print(v.shape)
                    #             # print(type(v))
                    #             # print(v.grad)
                    #             # print(v.grad.shape)
                    #             # 329 * 4096 + 5 = 1347589 == 122 * 11008 + 4612
                    ...
                    if step_number % 2 == 0:
                        ...
                        for k, v in model.named_parameters():
                            ...
                            for sn_x in sn_dict.keys():
                                if sn_x in k and 'mlp' in k and 'up_proj' in k:
                                    mask = torch.zeros_like(v.grad)

                                    for sn_y in sn_dict[sn_x]:
                                        print(sn_x + '_' + sn_y + '_' + 'up_proj')
                                        sn_y = int(sn_y)
                                        mask[sn_y * 4096: sn_y+1 * 4096] = 1

                                    v.grad *= mask

                                elif sn_x in k and 'mlp' in k and 'down_proj' in k:
                                    mask = torch.zeros_like(v.grad)

                                    for sn_y in sn_dict[sn_x]:
                                        print(sn_x + '_' + sn_y + '_' + 'down_proj')
                                        sn_y = int(sn_y)
                                        for i in range(4096):
                                            index = i * 11008 + sn_y
                                            mask[index] = 1
